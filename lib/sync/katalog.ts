...
/**
 * Kaynaktaki ölçüyü OLDUĞU GİBİ aktarır.
 *
 * Sayısal alanlar yalnızca CRM gönderdiyse dolar; metinden çıkarım
 * YAPILMAZ. Daha önce `raw` metninden ölçü türetiliyordu ve bu 92
 * aksesuarda uydurma değer üretti: "150 мл" (difüzör hacmi) genişlik
 * 150 cm, "115 см" (yapay ağaç boyu) genişlik 115 cm olarak yazıldı.
 * Ölçünün hangi eksene ait olduğu metinden bilinemez — tahmin etmek
 * yanlış veri demek. Ne geliyorsa o yazılır, gerisi `raw` içinde durur.
 */
export function olculeriCoz(o?: KaynakOlcu | null): {
  ...
  if (!o) return { widthCm: null, depthCm: null, heightCm: null, dimensionsRaw: null };
  return {
